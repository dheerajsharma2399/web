...
values
 ('Dark Chocolate Bar','chocolate',299,10000,'70% cocoa'),
 ('Gummy Bears','candy',199,10000,'Assorted fruit'),
 ('Choco Chip Cookie','cookie',149,10000,'Crispy edges'),
 ('Red Velvet Cake','cake',1999,10000,'1 kg whole cake')
